...
--	New  --
		...
		genes = {
			label		= {	low = "txtHelpGeneCostMin", 	high = "txtHelpGeneCostMax",},
			icon 		= {	low = "iconHelpGeneCostMin", 		high = "iconHelpGeneCostMax",},
		},
		influence = {
			label		= {	low = "txtHelpInfluenceCostMin", 	high = "txtHelpInfluenceCostMax",},
			icon 		= {	low = "iconHelpInfCostMin", 		high = "iconHelpInfCostMax",},
		},
		biomass = {
			label		= {	low = "txtHelpBioCostMin", 			high = "txtHelpBioCostMax",},
			icon 		= {	low = "iconHelpBioCostMin",			high = "iconHelpBioCostMax",},
		},
		bigbug = {
			label		= {	low = "txtHelpVehicleCostMin", 		high = "txtHelpVehicleCostMax",},
			icon 		= {	low = "iconHelpBigBugCostMin",		high = "iconHelpBigBugCostMax",},
		},
		tsmsquad = {
			label		= {	low = "txtHelpSquadCostMin", 		high = "txtHelpSquadCostMax",},
			icon 		= {	low = "iconHelpTSMSquadCostMin",	high = "iconHelpTSMSquadCostMax",},
		},
		tsbiomass = {
			label		= {	low = "txtHelpReqCostMin", 		high = "txtHelpReqCostMax",},
			icon 		= {	low = "iconHelpTSBioCostMin",	high = "iconHelpTSBioCostMax",},
		},
		tsinfluence = {
			label		= {	low = "txtHelpPowerCostMin", 		high = "txtHelpPowerCostMax",},
			icon 		= {	low = "iconHelpTSInfCostMin",	high = "iconHelpTSInfCostMax",},
		},		
	}
}
...
tooltip_cost = 
{
	...
	{ bind = "scar_button", ui = "ScarTooltipTyranids", tt = {},
		dependant = {
			{ bind = "selector_help_text_level",
				low = {
					-- cost: text label
					{ bind = "cost_label", ui = widgets.res.label.low },
					
					-- biomass
					{ bind = "resource_cost_label", ui = widgets.res.biomass.label.low, res_type = "requisition", valid_when_zero = false, valid_when_no_req = false,
						-- biomass case: influence goes right
						dependant = {
							{ bind = "image", ui = widgets.res.biomass.icon.low },
							
							-- influence resource
							{ bind = "resource_cost_label", ui = "txtHelpInfluenceRightCostMin", res_type = "faith", valid_when_zero = true, valid_when_no_req = false,
								dependant = {	{ bind = "image", ui = "iconHelpInfCostMinRight" }, 	},
							},
						},
						-- no biomass case: influence goes left
						exclusive = {
							-- influence resource - only show when not zero
							{ bind = "resource_cost_label", ui = widgets.res.influence.label.low, res_type = "faith", valid_when_zero = false, valid_when_no_req = false,
								dependant = {	{ bind = "image", ui = widgets.res.influence.icon.low }, 	},
							},
						},
					},
					...
					-- vehicle cap
					{ bind = "popcap_cost_label", ui = widgets.res.vehicle.label.low, cap_type = "support", valid_when_zero = false, valid_when_no_req = true,
						dependant = {	{ bind = "image", ui = widgets.res.bigbug.icon.low }, 	},
					},
				},
				high = {
					-- cost: text label
					...
					-- biomass
					{ bind = "resource_cost_label", ui = widgets.res.biomass.label.high, res_type = "requisition", valid_when_zero = false, valid_when_no_req = false,
						-- biomass case: influence goes right
						dependant = {
							{ bind = "image", ui = widgets.res.biomass.icon.high },
							
							-- influence resource
							{ bind = "resource_cost_label", ui = "txtHelpInfluenceRightCostMax", res_type = "faith", valid_when_zero = true, valid_when_no_req = false,
								dependant = {	{ bind = "image", ui = "iconHelpInfCostMaxRight" }, 	},
							},
						},
						-- no biomass case: influence goes left
						exclusive = {
							-- influence resource - only show when not zero
							{ bind = "resource_cost_label", ui = widgets.res.influence.label.high, res_type = "faith", valid_when_zero = false, valid_when_no_req = false,
								dependant = {	{ bind = "image", ui = widgets.res.influence.icon.high }, 	},
							},
						},
					},
					...
					-- vehicle cap
					{ bind = "popcap_cost_label", ui = widgets.res.vehicle.label.high, cap_type = "support", valid_when_zero = false, valid_when_no_req = true,
						dependant = {	{ bind = "image", ui = widgets.res.bigbug.icon.high }, 	},
					},
				},
			},
		},
